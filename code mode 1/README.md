...
### Installation
``` bash
git clone https://github.com/GTFRL/Benchmarking-of-Reinforcement-Learning-via-Converse-Optimality.git
...
* F-test plot comparing the distribution of rewards showing whether optimizer choice changes reward variance across generated tasks.
![an example of the runs](../GFX/f_test_plot_Adam_RAdam_2.png) 
* Kernel Density Estimate (KDE) plot visualizing the reward distributions for Adam and RAdam.
![an example of the runs](../GFX/kde_plot_Adam_RAdam_edited.svg)
* Box plot comparing the final rewards obtained using Adam and RAdam optimizers.
![an example of the runs](../GFX/box_plot_Adam_RAdam_Styled.svg "Box Plot for Adam and RAam with the final negative cost (reward)")
<a name="exp2"></a>
